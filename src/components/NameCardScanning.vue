<template>
  <div class="container">
    ...
    <button type="button" @click="selectImages" class="position-absolute text-center text-white border-0 rounded-circle bg-yoov-primary shadow" id="captureButton">
      <i class="fa-solid fa-camera" ></i>
    </button>

    <button class="btn btn-info" @click="add" v-if="showAddToHomeScreenButton">Add To Home screen</button>
...
onMounted(()=>{
  ...
  nextTick().then(()=>{
    ...
    console.log("timeout",fileInput.value)
    updateImages()
